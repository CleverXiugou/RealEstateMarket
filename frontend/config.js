...
const STATUS_MAP = ["闲置", "融资中", "准备出租", "待出租", "出租中"];
const STATUS_BADGE_COLOR = ["bg-gray-100 text-gray-700", "bg-blue-100 text-blue-700", "bg-purple-100 text-purple-700", "bg-yellow-100 text-yellow-800", "bg-green-100 text-green-700"];
